...
Autodesk.ADN.Viewing.Extension.CustomFirstPersonTool = 
 ...
 function (viewer, options) {
    ...
    function AdnTool2(viewerapi, toolName) {
        ...
        var _movementSpeedDefault = 1.0;
        var _movementSpeed = 1.0;
       ...
       Autodesk.Viewing.Viewer3D.prototype.changeTouchType = function(x,y) {

            _deltaYaw += x * _lookSpeed;
            _deltaPitch += y * _lookSpeed;
...
function yaogan(){
    ...
    var touchX = getElementLeft(joystick),
        touchY = getElementTop(joystick);
        //获取绝对位置
    ...
    ji.src = '/src/img/yaogan/joy.png';
    jo.src = '/src/img/yaogan/background.png'; //加载图片
    // ji.classList.add('wwwwww');
