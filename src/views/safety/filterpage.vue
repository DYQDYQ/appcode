...
<script>
    ...
    export default{
        ...
        mounted(){
            var vm = this;
            mui.ajax({
                url:`${vm.$store.state.serverIp}/task/issue/issuelistcount/?issuetype=anquan&token=`+vm.$store.state.sessionid,
                type: "get",
                success(res){
            ...
            mui.ajax({
                url:`${vm.$store.state.serverIp}/task/issue/issuefilter_initdata/?issuetype=anquan&token=`+vm.$store.state.sessionid,
                type: "get",
                success(res){
                    if(res.issuc){
