...
<!--                 <Select v-model="formItem.templates" size="small">
        ...
        <transition name="bottomdrawer">
            <div v-if="showcamera" class="bottomdrawer newcamera">
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            mui.ajax(`${vm.$store.state.serverIp}/task/issue/getissuenumber/?issuetype=安全问题&token=`+vm.$store.state.sessionid,{
                crossDomain:true,
                success(res){
                    if(res.res==="sucess"){
            ...
            mui.ajax(`${vm.$store.state.serverIp}/task/issue/getmajortemplate/?issuetype=安全问题&token=`+vm.$store.state.sessionid,{
                crossDomain:true,
                success(res){
                    if(res.issuc==="true"){
                        let arr = [];
