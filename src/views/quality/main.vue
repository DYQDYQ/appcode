...
<template>
    <div class="mains" style="margin: 0;">
        ...
        <transition name="adddrawer">
            <addpage class="adddrawer" style="z-index: 1000" ref="addlists" v-if="show == 'addlist'"></addpage>
        </transition>
        <!-- 整改单数据图表示 -->
        <transition name="maindrawer">
        ...
        <!-- <transition name="leftdrawer">
            <filterpage class="leftdrawer" v-if="showfilter && show == 'showlist'"></filterpage>
        </transition> -->
